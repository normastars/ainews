PROJECT_NAME := "github.com/normastars/frame/api-template"
PKG := "$(PROJECT_NAME)"
...
build-min-docker:
	...
	make clean
	# make linux
	# TODO: need fix <registername> and <imagename>
	docker build -t normastars/api-template:v0.0.6 -f build/docker/Dockerfile .
